export const questions = [
    ...
    },
    {
        ...
        answer:"Synthetic events combine the response of different browser's native events into on API, ensuring that."
    },
    {
        id:5,
        question:'What are the component in React?',
        answer:'Components are the building blocks of any React application, and a single app a single app usually consists of multiple.'
    }
]